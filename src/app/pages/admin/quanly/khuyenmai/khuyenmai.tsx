...
export default function QuanLyNguoiDung() {
  ...
  useEffect(() => {
    axios.get("http://localhost:8000/api/voucher") // sửa lại URL nếu khác
      .then((res) => {
    ...
    <div className="grid grid-cols-12 gap-4 bg-[#fff8f0]">
        ...
        <div className="col-span-12">
            <Card className="bg-[#fff7f2]">
                ...
                <div className="col-span-12 md:col-span-3">
                    <label className="text-sm text-gray-700 font-medium block mb-1">Giá trị khuyến mãi</label>
                    <select className="w-full bg-gray-200 px-4 py-2 rounded-md ">
                    <option>Tất cả</option>
      ...
      <div className="col-span-12 grid grid-cols-12 gap-4">
        {[
          ...
          { label: "Tổng số nhân khuyến mãi còn hạn", value: vouchers.filter(voucher => voucher.status === 'active').length },
        ].map((item, i) => (
