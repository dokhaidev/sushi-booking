      ...
      <section className="relative bg-gradient-to-br from-[#FAF4EC] via-[#F8F1E9] to-[#F5EDE3] py-20 px-6 sm:px-12 lg:px-20 flex items-center">
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12 relative z-10">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#F7F1E5] to-[#F4E7D2] border border-[#A68345]/30 rounded-full px-5 py-2 mb-6 shadow-lg backdrop-blur-sm">
            ...
            <p className="text-[#555] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
              {t("description")}
            </p>
          ...
          <div className="lg:w-1/2">
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border border-[#F4E7D2] group">
              <img
                ...
                alt={t("image_alt")}
                className="object-cover w-full h-[400px] lg:h-[480px] group-hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
