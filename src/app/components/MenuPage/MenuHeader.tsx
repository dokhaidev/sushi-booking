...
export default function Menus() {
  ...
  // Lấy danh sách hiển thị theo showAll
  ...
  return (
    <section
      id="menu"
      className="relative overflow-hidden py-[60px] sm:px-6 lg:px-18 bg-[#B1B6A3]"
    >
      ...
      <div className="relative z-10 container mx-auto">
        ...
        {loading ? (
          <div className="text-center py-8">
            ...
            <p className="text-[#666666] mt-2">Đang tải món ăn...</p>
          </div>
        ) : (
          <>
